...
1. Raw data based on field collection forms in [resources/raw_data/](https://github.com/SCBI-ForestGEO/Dendrobands/tree/master/resources/raw_data/)
1. Post-processed data in the `scbi.dendroAll_YEAR.csv` files in [data/](https://github.com/SCBI-ForestGEO/Dendrobands/tree/master/data/). This is the data to be used for analysis.

Whenever raw data is pushed to GitHub, GitHub Actions continuous integration performs data QA/QC and produces the post-processed data according to the steps in [`.github/workflows/QA_QC_checks.yaml`](https://github.com/SCBI-ForestGEO/Dendrobands/tree/master/.github/workflows/QA_QC_checks.yaml)
