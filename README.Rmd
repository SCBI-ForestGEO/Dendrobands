...
Whenever raw data is pushed to GitHub, GitHub Actions continuous integration automatically performs data QA/QC takes this raw data and produces the post-processed data according to the steps in [`.github/workflows/QA_QC_checks.yaml`](https://github.com/SCBI-ForestGEO/Dendrobands/tree/master/.github/workflows/QA_QC_checks.yaml)
